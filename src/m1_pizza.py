...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = '80 purple dots on a black circle'
    window = rg.RoseWindow(440, 400, title)
    circle = rg.Circle(rg.Point(220, 200), 150)
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    # Test 1:
    title = 'PIZZA Test 4, 200 lines on a yellow circle.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_polygon():
    ...
    circle.outline_thickness = 3
    polygon(window, circle, 9, 'orange', 5)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    circle.fill_color = 'yellow'
    fancy_polygon(window, circle, 300, 61, 'black', 2)
    window.close_on_mouse_click()

    title = 'FANCY POLYGON test 5:  20 lime green lines on blue circle, hops = 7.'
    window = rg.RoseWindow(480, 350, title)
    ...
    title = 'FANCY POLYGON test 6:  20 lime green lines on blue circle, hops = 7.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'green'
    fancy_polygon(window, circle, 20, 5, 'orange', 2)
    window.close_on_mouse_click()
